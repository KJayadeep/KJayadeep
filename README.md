...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=YOUR_GITHUB_USERNAME&label=Profile%20Views&color=2EA3F7&style=flat" alt="profile views" />
...
const developer = {
  ...
  stack: ["MongoDB", "Express.js", "React", "Node.js", "PostgreSQL"],
  currentFocus: "Building CI/CD pipelines supercharged with AI",
  funFact: "I debug with console.log() and I'm not ashamed",
};
```

- 🔭 Currently building full-stack apps with the **MERN** stack + **PostgreSQL**
- ⚙️ Automating deployments with **CI/CD pipelines** enhanced by **AI tooling**
- 🌱 Always learning — currently diving deeper into AI-assisted developer workflows
- 💬 Ask me about React, Node.js, REST/GraphQL APIs, or database design
- ⚡ Fun fact: I ship faster with AI pair-programming
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=mongodb,express,react,nodejs,postgres,js,ts,html,css,tailwind,git,github,docker,githubactions,figma,vscode,postman&perline=8" />
</p>

<details>
<summary>📦 Deep dive into my toolbox</summary>
<br/>
...
![OpenAI](https://img.shields.io/badge/-AI%20Tooling-412991?style=for-the-badge&logo=openai&logoColor=white)
